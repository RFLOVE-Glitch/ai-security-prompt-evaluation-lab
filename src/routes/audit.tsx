  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Audit Evidence" },
      {
        ...
        content:
          "What an assurance reviewer would need to reconstruct a synthetic evaluation run.",
      },
    ],
  }),
  component: AuditPage,
      ...
      <Panel>
        ...
        <dl>
          <KeyValue label="Integrity">
            Tamper-evident storage with real digests over run inputs, fixtures and
            code version. Placeholders here.
          </KeyValue>
          <KeyValue label="Provenance">
            Probe corpus version, rubric version, and system-under-test build pinned
            per run.
          </KeyValue>
          <KeyValue label="Identity">
            Authenticated reviewer identity and dual sign-off on critical findings.
            Reviewers here are mock labels.
          </KeyValue>
          <KeyValue label="Retention & export">
            Defined retention window and an attested export format for external
            auditors. Not implemented.
          </KeyValue>
          <KeyValue label="Change history">
            Diffs when a rubric weight or band boundary moves, since that changes the
            meaning of every historical score.
          </KeyValue>
        </dl>
      </Panel>
    </AppShell>
